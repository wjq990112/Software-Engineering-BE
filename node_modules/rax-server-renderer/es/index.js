...
function styleToCSS(style, options) {
  ...
  for (var prop in style) {
    ...
    var type = typeof val; // Handle unit for all numerical property, such as fontWeight: 600 / fontWeight: '600'
...
function checkContext(element) {
  ...
  if (element.contextTypes || element.childContextTypes) {
    console.error('Warning: ' + 'The legacy "contextTypes" and "childContextTypes" API not working properly in server renderer, ' + 'use the new context API. ' + ("(Current: " + shared.Host.owner.__getName() + ")"));
  }
}
